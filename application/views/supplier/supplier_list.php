...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Supplier List</h2>
		...
		<?php if ($_SESSION['hak_akses'] == 'K' ){
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('supplier/read/'.$supplier->id_supplier),'Read'); 
				echo ' | '; 
		...
		<?php echo anchor(site_url('supplier/excel'), 'Excel', 'class="btn btn-primary"'); ?>
	    </div>
